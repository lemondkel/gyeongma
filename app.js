...
var horseBreaker = require('./routes/horseBreaker');
var horseRiding = require('./routes/horseRiding');
var horseJockey = require('./routes/horseJockey');
...
app.use('/horseBreaker', horseBreaker);
app.use('/horseRiding', horseRiding);
app.use('/horseJockey', horseJockey);
